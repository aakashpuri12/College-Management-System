...
EMAIL_HOST_PASSWORD = os.environ.get('admin@123')
EMAIL_USE_TLS = True
# DEFAULT_FROM_EMAIL = "School Management System <admin@admin.com>"

STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

# Production DATABASE_URL configuration is disabled for local development.
# SQLite database defined above will be used.
